...
Use SHARED/compare-framework.md scoring. Mark as breaking when a public contract, error behavior, persistence format, security property, or required dependency changes. Mark as high risk when relationships or registration paths disappear.
